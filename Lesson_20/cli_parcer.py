...
# lesson
parser = ArgumentParser(description='Parser for numbers args in this file')


parser.add_argument('--number_1', help='Integer num in range 1-10', default=5)
parser.add_argument('--number_2', help='Integer num in range 10-20', default=15)
